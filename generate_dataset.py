...
class Scene:
    def __init__(self,bg,img1, class1, hulla1,img2, class2,hulla2,img3=None, class3=None,hulla3=None,hullb3=None):
        if img3 is not None:
            self.create3CardsScene(bg,img1, class1, hulla1,img2, class2,hulla2,img3, class3,hulla3,hullb3)
        else:
...
class Cards():
    ...
    def get_random(self, card_name=None, display=False):
        ...
        if display:
            if display: display_img(card,[hull],"rgb")
